...
class Dice<T> {
	...
	/*
	 * Compare the current dice values with other dice's values: we consider that
	 * the order of inserting values == importance. example: A > B > C > D.
	 * otherwise, we can implement the Comparable interface and use compateTo
	 * method.
	 */
